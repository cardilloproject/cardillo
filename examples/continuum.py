...
def test_cylidner():
    ...
    # # def b2(t, phi0=np.pi/8, h=0):
    # #     cDOF2_xyz = cDOF2.reshape(-1, 3)
    # #     # out = Z[cDOF2]
    # #     out = Z.copy()
    ...
    for i in range(10):
        t = i + 1
        # z = continuum.z(t / 10, Z[continuum.qDOF])
        continuum.post_processing(t, Z[continuum.qDOF], f'continuum{i}.vtu')
