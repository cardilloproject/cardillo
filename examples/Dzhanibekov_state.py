...
a_Box1pvd = PVDReader(
    registrationName="_Box1.pvd",
    FileName="\\\\wsl.localhost\\Ubuntu\\home\\lisa\\git-projects\\cardillo\\examples\\Dzhanibekov_rigid_body\\_Box1.pvd",
)
a_Box1pvd.CellArrays = ["v", "Omega", "ex", "ey", "ez"]

# create a new 'Glyph'
glyph2 = Glyph(registrationName="Glyph2", Input=a_Box1pvd, GlyphType="Arrow")
glyph2.OrientationArray = ["CELLS", "ey"]
glyph2.ScaleArray = ["CELLS", "ey"]
glyph2.GlyphTransform = "Transform2"

# create a new 'Glyph'
glyph1 = Glyph(registrationName="Glyph1", Input=a_Box1pvd, GlyphType="Arrow")
glyph1.OrientationArray = ["CELLS", "ex"]
glyph1.ScaleArray = ["CELLS", "ex"]
glyph1.GlyphTransform = "Transform2"

# create a new 'Glyph'
glyph3 = Glyph(registrationName="Glyph3", Input=a_Box1pvd, GlyphType="Arrow")
...
# create a new 'PVD Reader'
a_Box0pvd = PVDReader(
    registrationName="_Box0.pvd",
    FileName="\\\\wsl.localhost\\Ubuntu\\home\\lisa\\git-projects\\cardillo\\examples\\Dzhanibekov_rigid_body\\_Box0.pvd",
)
...
a_Box0pvdDisplay.ScaleTransferFunction.Points = [
    -15.00001,
    0.0,
    0.5,
    0.0,
...
a_Box0pvdDisplay.OpacityTransferFunction.Points = [
    -15.00001,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
glyph2Display.ScaleTransferFunction.Points = [
    -0.029275518494948277,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
glyph2Display.OpacityTransferFunction.Points = [
    -0.029275518494948277,
    0.0,
    0.5,
    0.0,
