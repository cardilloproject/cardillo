...
if __name__ == "__main__":
    ...
    Q = straight_configuration(p, nEl, L, greville_abscissae=False, basis='lagrange')
    q0 = Q.copy()
    nn = p*nEl + 1
    # q0[nn + 1] += 1.0e-3
    # q0[2 * nn + 1] += 1.0e-3
    ...
    beam = Timoshenko_director_dirac(material_model, A_rho0, B_rho0, C_rho0, p, nQP, nEl, Q=Q, q0=q0, basis='lagrange')
    ...
    # beam = Inextensible_Euler_Bernoulli_director_integral(material_model, A_rho0, B_rho0, C_rho0, p, nQP, nEl, Q=Q, q0=q0, basis='lagrange')
    # exit()
