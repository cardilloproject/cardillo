...
class MaxwellElementForceElement:
    def __init__(self, mass, stiffness, damping, l0, x0, g_d0, x_dot0):
        ...
        pm.name = "point mass"
        self.system.add(pm)
        max = MaxwellElementFL(self.system.origin, pm, stiffness, damping, g_sref=l0, q0=np.array([g_d0]))
...
if __name__ == "__main__":
    ...
    system = MaxwellElementForceElement(mass, stiffness, damping, l0, x0, x_D0, x_dot0).get_system()
