...
# TODO: What is the difference of this version and the condensed below?
class MoreauGGL:
    ...
    def update(self, xk1):
        dt = self.dt
        q_dotk1, u_s_dotk1, Uk1, la_gk1, P_Nk1, mu_Nk1, P_Fk1 = self.unpack(xk1)

        qk1 = self.qk + dt * q_dotk1
        u_sk1 = self.uk + dt * u_s_dotk1
        uk1 = u_sk1 + Uk1
    ...
    def R(self, tk1, xk1, update_index_set=False, primal_form=False):
        ...
        # equations of motion
        #####################
        R[nq : nq + nu] = Mk1 @ u_s_dotk1 - self.model.h(tk1, qk1, uk1) - W_gk1 @ la_gk1
