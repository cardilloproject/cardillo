...
class Rattle:
    ...
    def R_x1(self, x1n1, y1n1):
        ...
        R[self.split_x1[0] : self.split_x1[1]] = (
            self.Mn @ (un12 - un)
            - 0.5 * dt * (self.system.h(tn, qn, un12) + self.system.W_tau(tn, qn,format="csr") @ self.system.la_tau(tn, qn, un12) + self.W_cn @ la_c1)
            - (
                self.W_gn @ P_g1
    ...
    def R_x2(self, x2n1, y2n1):
        ...
        R[: self.split_x2[0]] = (
            self.Mn @ (un1 - un12)
            - 0.5 * dt * (self.system.h(tn1, qn1, un12) + self.system.W_tau(tn1, qn1,format="csr") @ self.system.la_tau(tn1, qn1, un12) + self.W_cn @ self.la_c2)
            - (
                self.W_gn @ P_g2
