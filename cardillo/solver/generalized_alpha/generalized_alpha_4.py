...
class Generalized_alpha_4():
    ...
    def __init__(self, model, t1, dt, uDOF_algebraic=None, \
        ...
        # constraints on position, velocity and acceleration level + corresponding equations (EQM, two kinematic equations) 
        # + constraints on velocitiy level (TODO: they have to be enforced on acceleration level too)
    ...
    def unpack(self, x):
        ...
        La_g = x[3*nu+nla_g:3*nu+2*nla_g] # Lagrange multiplier position correction
        ...
        # TODO: velocity constraints on acceleration level!
