...
class Generalized_alpha_4_index1():
    ...
    def __R_gen_analytic(self, tk1, xk1):
        ...
        Ra_U = rhs_u
        Ra_Q = Ma_q @ self.q_Q + rhs_q @ self.q_Q
        ...
        # R[nu:2*nu] = Mk1 @ Uk1 - W_gk1 @ La_gk1
        #########################################
        WLa_g_q = self.model.Wla_g_q(tk1, qk1, La_gk1)
        MU_q = self.model.Mu_q(tk1, qk1, Uk1)
        RU_q = MU_q - WLa_g_q
        ...
        Rkappa_g_a = Rkappa_g_a
        Rkappa_g_U = None
        Rkappa_g_Q = Rkappa_g_Q
...
class Generalized_alpha_4_singular_index3():
    ...
    def __R_gen_analytic(self, tk1, xk1):
        ...
        # R[nu:nu+nla_g] = self.model.g(tk1, qk1)
        #########################################
        Rla_g_g_q = self.model.g_q(tk1, qk1)
        Rla_g_g_a = Rla_g_g_q @ self.q_a

        Rla_g_a_dyn = Rla_g_g_a[:, uDOF_dyn]
        Rla_g_a_alg = Rla_g_g_a[:, uDOF_alg]
