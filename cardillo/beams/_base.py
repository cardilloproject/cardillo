...
# TODO: Should they all be static methods?
class RotationParameterizationBase(ABC):
    ...
    @abstractmethod
    def Exp_SO3(self, psi):
        ...

    @abstractmethod
    def Exp_SO3_psi(self, psi):
        ...

    @abstractmethod
    def Log_SO3(self, A_IK):
        ...

    @abstractmethod
    def q_dot(self, psi, K_omega_IK):
        ...

    @abstractmethod
    def q_dot_q(self, psi, K_omega_IK):
        ...
    ...
    @abstractmethod
    def q_ddot(self, psi, K_omega_IK, K_omega_IK_dot):
        ...

    @abstractmethod
    def step_callback(self, psi):
        ...
...
class AxisAngleRotationParameterization(RotationParameterizationBase):
    ...
    def q_ddot(self, t, psi, K_omega_IK, K_omega_IK_dot):
        raise NotImplementedError
...
class TimoshenkoPetrovGalerkinBaseQuaternion(RodExportBase, ABC):
    def __init__(
        self,
        cross_section,
        material_model,
        ...
        This implements the transformation matrices parameterized by quaternions."""
