...
def make_TimoshenkoPetrovGalerkinBase(RotationBase):
...
TimoshenkoPetrovGalerkinBaseAxisAngle = make_TimoshenkoPetrovGalerkinBase(
    AxisAngleRotationParameterization
)
TimoshenkoPetrovGalerkinBaseQuaternion = make_TimoshenkoPetrovGalerkinBase(
