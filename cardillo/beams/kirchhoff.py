...
class Kirchhoff(RodExportBase):
    ...
    def _alpha_KeJ(self, qe, xi):
        ...
        # # smallest rotation from K0_e_x^K0 to K0_r_x_J
        # A_K0K1_SR = smallest_rotation(e1, K0_e_x_K1)
        # K0_e_x_K1_SR, K0_e_y_K1_SR, K0_e_z_K1_SR = A_K0K1_SR.T

        # # torsion error
        # A_K0K1 = A_IK0.T @ A_IK1
        # K0_e_x_K1, K0_e_y_K1, K0_e_z_K1 = A_K0K1.T
        # sin = K0_e_y_K1_SR @ K0_e_z_K1
        # cos = K0_e_y_K1_SR @ K0_e_y_K1
    ...
    def _eval(self, qe, xi):
        ...
        k_1 = -e_x_K0 @ kappa_IK_bar_perp / denom + alpha * N1_xi
...
class KirchhoffBubnovGalerkin(RodExportBase):
    def __init__(
        self,
        cross_section,
        material_model,
