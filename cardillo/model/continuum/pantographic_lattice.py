        ...
        for i in range(self.nqp):
            ...
            for a in range(self.nn_el):
                ...
                f[self.nodalDOF[a]] -= (  
                                        ...
                                        + W_Gamma * Gamma_q
                                        + W_theta_s[0, 0] * theta1_1_q + W_theta_s[1, 1] * theta2_2_q
                                        ) * w_J0
            ...
            for a in range(self.nn_el):
                ...
                for b in range(self.nn_el):
                    ...
                    Ke[np.ix_(ndDOFa, ndDOFb)] -= (
                        ...
                        + W_Gamma * Gamma_qq
                        + W_theta_s[0, 0] * theta1_1_qq + W_theta_s[1, 1] * theta2_2_qq 
                        + W_rho_rho[0, 0] * np.outer(rho1_q[ndDOFa], rho1_q[ndDOFb]) + W_rho_rho[1, 1] * np.outer(rho2_q[ndDOFa], rho2_q[ndDOFb]) 
