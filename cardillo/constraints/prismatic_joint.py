...
class PrismaticJoint:
    def __init__(
        ...
        """Implementation of a prismatic joint, i.e., a sliding joint that
        slides along the axis e_x^B defined by `A_IB`. Consequently, no
        relative rotation is allowed between both subsystems.

        References:
        -----------
        ROS-URDF: http://wiki.ros.org/urdf/XML/joint
        """
        self.nla_g = 5
    ...
    def assembler_callback(self):
        ...
        self.K1_J_R1 = lambda t, q: self.subsystem1.K_J_R(t, q[:nq1], self.frame_ID1)
        self.K1_J_R1_q1 = lambda t, q: self.subsystem1.K_J_R_q(
            t, q[:nq1], self.frame_ID1
        )
        ...
        self.K2_J_R2 = lambda t, q: self.subsystem2.K_J_R(t, q[nq1:], self.frame_ID2)
        self.K2_J_R2_q2 = lambda t, q: self.subsystem2.K_J_R_q(
            t, q[nq1:], self.frame_ID2
        )
    ...
    def g(self, t, q):
        ...
        return np.array(
            [r_P1P2 @ ey1, r_P1P2 @ ez1, ex1 @ ey2, ey1 @ ez2, ez1 @ ex2], dtype=q.dtype
        )
    ...
    def g_q_dense(self, t, q):
        ...
        g_q[0, :nq1] = -ey1 @ self.r_OB1_q1(t, q) + r_P1P2 @ ey1_q
        g_q[0, nq1:] = ey1 @ self.r_OB2_q2(t, q)
        g_q[1, :nq1] = -ez1 @ self.r_OB1_q1(t, q) + r_P1P2 @ ez1_q
        g_q[1, nq1:] = ez1 @ self.r_OB2_q2(t, q)
        g_q[2, :nq1] = ey2 @ ex1_q
        g_q[2, nq1:] = ex1 @ ey2_q
        g_q[3, :nq1] = ez2 @ ey1_q
        g_q[3, nq1:] = ey1 @ ez2_q
    ...
    def g_dot(self, t, q, u):
        r_P1P2 = self.r_OB2(t, q) - self.r_OB1(t, q)
        ex1, ey1, ez1 = self.A_IB1(t, q).T
        ex2, ey2, ez2 = self.A_IB2(t, q).T

        v_P1P2 = self.v_B2(t, q, u) - self.v_B1(t, q, u)
    ...
    def g_ddot(self, t, q, u, u_dot):
        ...
        a_P1P2 = self.a_B2(t, q, u, u_dot) - self.a_B1(t, q, u, u_dot)
    ...
    def Wla_g_q(self, t, q, la_g, coo):
        ...
        r_OP2 = self.r_OB2(t, q)
        r_P1P2 = r_OP2 - r_OP1
        r_OP1_q = self.r_OB1_q1(t, q)
        r_OP2_q = self.r_OB2_q2(t, q)
        ...
        J_P1 = self.J_B1(t, q)
        J_P2 = self.J_B2(t, q)
        J_P1_q = self.J_B1_q1(t, q)
        J_P2_q = self.J_B2_q2(t, q)
        J_R1 = self.J_R1(t, q)
        J_R2 = self.J_R2(t, q)
