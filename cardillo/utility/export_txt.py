        ...
        match narg:
            case 2:
                function_value = np.array([
                    function(ti) for ti in solution.t
                ])
            case 3:
                function_value = np.array([
            ...
            case 4:
                function_value = np.array([
                    function(ti, qi, ui) for (ti, qi, ui) in zip(solution.t, solution.q, solution.u)
                ])
            case 5:
                function_value = np.array([
                    function(ti, qi, ui, u_doti) for (ti, qi, ui, u_doti) in zip(solution.t, solution.q, solution.u, solution.u_dot)
                ])
            case _:
