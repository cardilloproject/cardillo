...
def double_pendulum_urdf():
    ...
    initial_config = {}
    initial_config["joint1"] = np.pi/4
    initial_config["joint2"] = np.pi/3
    initial_vel = {}
    ...
    load_urdf(
        system,
        path.join("/home/vrv13/cardillo/urdf/examples/urdf_double_pendulum/urdf/double_pendulum.urdf"),
...
def double_pendulum_nonurdf():
    ...
    base_link = Meshed(Frame)(
        mesh_obj=Path("/home/vrv13/cardillo/examples/double_pendulum/stl/base_link.stl"),
    ...
    link1 = Meshed(RigidBody)(
        mesh_obj=Path("/home/vrv13/cardillo/examples/double_pendulum/stl/link1.stl"),
    ...
    link2 = Meshed(RigidBody)(
        mesh_obj=Path("/home/vrv13/cardillo/examples/double_pendulum/stl/link2.stl"),
    ...
    solver = ScipyDAE(system, 5, dt)  # create solver
    ...
    #  Rendering    #
    #################
    renderer = Renderer(system, [base_link, link1, link2, system.origin])
    renderer.render_solution(sol, repeat=True)
