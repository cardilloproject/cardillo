...
if __name__ == "__main__":
    ...
    r_N = 0.3
    e_N = 0
    sphere = Sphere_in_sphere(frame, R, RB, r, mu, prox_r_N=r_N, prox_r_T=r_N, e_N=e_N, e_T=0)
    ...
    if animate:
        ...
        COM_n, bdry_n, d1_n, d2_n, COM_fp, bdry_fp, d1_fp, d2_fp = create(0, q_n[0], q_fp[0])

        def update(t, q_n, q_fp, COM_n, bdry_n, d1_n, d2_n, COM_fp, bdry_fp, d1_fp, d2_fp):
        ...
        def animate(i):
            update(t[i], q_n[i], q_fp[i], COM_n, bdry_n, d1_n, d2_n, COM_fp, bdry_fp, d1_fp, d2_fp)
